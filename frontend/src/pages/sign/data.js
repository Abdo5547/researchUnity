...
export const institutionsWithFaculties = {
  ...
  "Université Mohammed V de Rabat": {
    ...
    "Faculté des Lettres et des Sciences Humaines": [
      ...
      { département: "Langue et Littérature Hispaniques" },
      { département: "Langue et Littérature Italiennes" },
    ],
...
export const keywordsdomain = [
  { domain: "Informatique", categories: [
    { category: "Développement Web", keywords: ["HTML", "CSS", "JavaScript", "Front-end", "Back-end", "CMS", "PHP", "Node.js", "React", "Angular", "Vue.js", "Django", "REST", "GraphQL"] },
    { category: "Bases de Données", keywords: ["SQL", "MySQL", "PostgreSQL", "MongoDB", "Redis"] },
    { category: "Réseaux et Sécurité", keywords: ["TCP/IP", "HTTP/HTTPS", "VPN", "Firewall", "Cryptographie", "SSL/TLS", "Injection SQL"] },
    { category: "Systèmes d'Exploitation", keywords: ["Windows", "Linux", "MacOS", "Unix", "Shell", "Processus", "Système de fichiers", "Permissions"] },
    { category: "Intelligence Artificielle et Data Science", keywords: ["Machine Learning", "Deep Learning", "Réseaux de neurones", "NLP", "Vision par ordinateur", "Data Mining", "Big Data", "Pandas", "NumPy", "SciPy", "TensorFlow", "PyTorch", "Keras"] },
    { category: "DevOps et Cloud Computing", keywords: ["AWS", "Azure", "Google Cloud Platform", "Docker", "Kubernetes", "Terraform", "Microservices", "CI/CD", "Monitoring", "Logging"] },
    { category: "Divers", keywords: ["IoT", "Blockchain", "Cryptomonnaie", "Réalité virtuelle", "Réalité augmentée", "Edge computing", "Quantum computing"] }
  ] },
  { domain: "Physique",categories:[{ category: "Physique", keywords: ["Mécanique quantique", "Relativité", "Physique des particules", "Astrophysique", "Thermodynamique", "Électromagnétisme", "Optique", "Acoustique", "Physique statistique"]}] },
  { domain: "Biologie",categories:[{ category: "Biologie", keywords: ["Biologie moléculaire", "Génétique", "Biotechnologie", "Écologie", "Biologie cellulaire", "Physiologie", "Évolution", "Microbiologie", "Biochimie"]}] },
  { domain: "Médecine",categories:[{ category: "Médecine", keywords: ["Anatomie", "Physiologie", "Pharmacologie", "Pathologie", "Microbiologie", "Chirurgie", "Neurologie", "Cardiologie", "Oncologie", "Pédiatrie"]}] },
  { domain: "Mathématiques",categories:[{ category: "Mathématiques", keywords: ["Algèbre", "Analyse", "Géométrie", "Probabilités", "Statistiques", "Calcul différentiel", "Calcul intégral", "Théorie des nombres", "Logique mathématique", "Théorie des ensembles"]}] },
  { domain: "Chimie",categories:[{ category: "Chimie", keywords: ["Chimie organique", "Chimie inorganique", "Chimie physique", "Chimie analytique", "Chimie des matériaux", "Catalyse", "Chimie quantique", "Spectroscopie", "Réactions chimiques"]}] }
];
