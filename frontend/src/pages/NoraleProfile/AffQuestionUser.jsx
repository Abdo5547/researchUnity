...
const AffQuestionUser = ({ donner }) => {
  ...
  const handleRecommendClick = async () => {
    ...
    try {
      if (newRecommendState) {
        ...
        toast.success("AffQuestionUser recommended successfully!");
      } else {
  ...
  const handleFollowedClick = async () => {
    ...
    try {
      if (newFollowState) {
        ...
        toast.success("AffQuestionUser followed successfully!");
      } else {
        const response = await axios({
          method: "delete",
  ...
  const nav =()=>{
    navigate('/Home/AffQuestionUser/QuestionDetail',{
     state:{
        questionId:res.id
      } 
    }
...
export default AffQuestionUser;
