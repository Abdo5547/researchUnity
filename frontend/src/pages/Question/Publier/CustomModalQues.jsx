...
const CustomModalDesc = ({ open, handleClose, content }) => {
  ...
  const handleSubmit = async () => {
    ...
    console.log( typeof plainString)
    ...
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/api/creatquest/",
        formData,
        {
          headers: {
      ...
      <Fade in={open}>
        ...
        >
          ...
          <Typography variant="subtitle1" sx={{ mt: 2 }}>
            Enter a clear and concise title for your discussion that others will
            easily understand. Please provide details or a starting point so
            others can contribute to the discussion.
          </Typography>
          <TextField
            fullWidth
            variant="outlined"
...
export default CustomModalDesc;
